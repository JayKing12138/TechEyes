  ...
  <div class="min-h-screen techeyes-page-shell history-shell">
    ...
    <main class="container mx-auto px-4 md:px-8 pt-28 md:pt-32 pb-14">
      <section class="techeyes-panel p-5 md:p-6">
        <div class="flex flex-col md:flex-row md:items-end md:items-between gap-4">
          <div>
      ...
      <div v-if="deleteConfirm.show" class="confirm-overlay" @click="cancelDelete">
        <div class="confirm-dialog" @click.stop>
          ...
          <p class="confirm-query">"{{ deleteConfirm.query }}"</p>
          <div class="confirm-actions">
            <button class="confirm-btn confirm-btn-cancel" @click="cancelDelete">取消</button>
            <button class="confirm-btn confirm-btn-delete" @click="executeDelete">删除</button>
          </div>
        </div>
      </div>
    </main>
...
import { getAnalysisHistory, getAnalysisResult, deleteAnalysisHistory } from '@/services/api'
